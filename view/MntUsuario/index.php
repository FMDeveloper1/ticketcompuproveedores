...
<html>
    ...
    <title>Compuproveedores</>::Mantenimiento Asesor</title>
</head>
		...
		<div class="container-fluid">
            <header class="section-header">
                <div class="tbl">
                    <div class="tbl-row">
                        <div class="tbl-cell">
                            <h3>Mantenimiento Asesor</h3>
                            <ol class="breadcrumb breadcrumb-simple">
                                <li><a href="#">Inicio</a></li>
                                <li class="active">Mantenimiento Asesor</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <table id="usuario_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    <thead>
                        <tr>
                            ...
                            <th class="d-none d-sm-table-cell" style="width: 15%;">Contrasena</th>
